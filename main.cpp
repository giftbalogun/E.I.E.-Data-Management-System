...
system("cls");//Clear screen
//Level-2 display
cout<<"\t\t\t\tE.I.E. STUDENTS INFORMATION AND BIO-DATA SECTION\n\n\n";
...
if(studentData.fname==find)
{
 ...
 cout<<"\n\t\t\t\t\tProgram: "<<studentData.classes<<endl<<endl;
}
...
cout<<"\t\t\t\tFACULTY/STAFF INFORMATION AND BIO-DATA SECTION\n\n\n";
cout<<"\t\t\t\t\t1. Create new entry\n";
...
case '3':
{
	cout<<"\n Done and Produced By ICE_Group10";
break;//outer case 3
}//outer case 3
}
break;//outer loop
...
int login(){
   ...
   if(pass == "pass"){
      ...
      cout << "\n\n\t\t\t\t\t\t\t\tAccess Denied (Contact Your Administrator Head) or...\n\t\t\t\t\t\t\t\tPlease Try Again\n\n";
      system("PAUSE");
      system("CLS");
      login();
   }
